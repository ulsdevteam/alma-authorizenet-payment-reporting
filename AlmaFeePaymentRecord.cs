...
namespace alma_authorizenet_payment_reporting
{
    ...
    public class AlmaFeePaymentRecord
    {
        ...
        public AlmaFeePaymentRecord(AlmaUser user, Fee almaFee, Transaction almaTransaction, transactionDetailsType authorizeTransaction, lineItemType lineItem, batchDetailsType batch)
        {
